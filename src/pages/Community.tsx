    ...
    <LightGate>
      <div className="min-h-screen bg-gradient-to-b from-primary-pale via-background to-background">
        ...
        <div className="container mx-auto px-3 sm:px-4 py-4 sm:py-6 max-w-full overflow-hidden">
          <div className="flex gap-4 sm:gap-6 lg:items-start">
            {/* Left Sidebar - FUN Ecosystem - STICKY */}
            <div className="hidden xl:block flex-shrink-0 lg:sticky lg:top-4 lg:self-start lg:max-h-[calc(100vh-2rem)] lg:overflow-y-auto">
              <FunEcosystemSidebar />
            </div>

            {/* Main Content Area */}
            <div className="flex-1 min-w-0 grid lg:grid-cols-3 gap-4 sm:gap-6 lg:items-start">
